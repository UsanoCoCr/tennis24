...
features = df.drop(['game_victor', 'player1_quality', 'player2_quality', 'player1_quality_squared', 'player2_quality_squared'], axis=1)
...
torch.save(model.state_dict(), './ablation_models/gru_reset.pth')
